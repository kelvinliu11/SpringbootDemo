...
<div id="wrapper">
        ...
        <ul class="nav" id="side-menu">
          ...
          <li>
            ...
            <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
              <li>
                <a href="#" onclick="viewActionPage('addSupplier', '新增供应商');">新增供应商</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
              <li>
                <a href="#" onclick="viewActionPage('addAsset', '新增资产包');">新增资产包</a>
              </li>
            </ul>
            <!-- /.nav-second-level -->
          </li>
  ...
  <div id="page-wrapper">
    <div class="container" style="width: 100%;margin-left:-4.7%">
...
<script language="JavaScript">
    function viewActionPage(elementName, tabTitle) {
        ...
        var elementAction = "<%=request.getContextPath()%>" + elementName;
        if ($(elementLi).length == 0) {
            $("#myTab").append(
                "<li id=\"" + elementName + "Li\" class=\"active\"" +
                "style=\"display: block;\">" +
                "<a href=\"" + elementDiv + "\" data-toggle=\"tab\" onclick=\"navLiClick('" + elementName + "\');\"> " + tabTitle + "</a>" +
                "</li>");
            $("#myTabContent").append("<div class=\"tab-pane fade in active\" id=\"" + elementName + "Div\" style=\"display: block;\"><section class=\"content\"><iframe src=\"" + elementAction + "\"style=\"width: 80%; height:100%; margin:80px 0 0 20%;\"></iframe></section></div>");
        }
        else {
