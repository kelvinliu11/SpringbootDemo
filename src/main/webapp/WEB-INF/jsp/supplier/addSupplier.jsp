...
<div id="wrapper" style="width: 30%;margin:0 auto">
      ...
      <form role="form">
        <div class="form-group">
          <label>合作商名称</label>
          <input class="form-control" placeholder="合作商名称" style="min-width: 300px;" id="supplierName">
        </div>
        <div class="form-group">
          <label>合作商类型</label>
        ...
        <button type="button" class="btn btn-default" onclick="addSupplier();">提交</button>
      </form>
</div>
...
<script language="JavaScript">
    function addSupplier() {
        $.ajax({
            type : "POST",  //提交方式
            url : "<%=request.getContextPath()%>/supplier/add/do",//路径
            async:false,
            data : {
