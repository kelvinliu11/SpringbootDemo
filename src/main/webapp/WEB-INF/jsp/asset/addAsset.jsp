...
<div id="wrapper" style="width: 30%;margin:0 auto;margin-left: 200px;">
        ...
        <div class="table-responsive" style="width: 500px;">
          <table class="table">
            ...
            <tr>
              <td>资产包名称:</td>
              <td><input class="form-control" placeholder="合作商名称" style="display: inline;width: 200px;" id="assetName"></td>
            </tr>
            <tr>
              <td>供应商名称:</td>
              <td>
            ...
            <tr>
              <td>资产获取日期:</td>
              <td><input type="text" style="width: 120px;" value="2017-07-01 00:00" id="datetimepickerPurchaseDate" data-date-format="yyyy-mm-dd hh:ii"></td>
            </tr>
            <tr>
              <td>资产包总额:</td>
              <td><input class="form-control" placeholder="资产包总额" style="display: inline;width: 200px;" id="saleAmount"></td>
            </tr>
            <tr>
              <td>年利率:</td>
              <td><input class="form-control" placeholder="年利率" style="display: inline;width: 200px;" id="predictYearRate"></td>
            </tr>
            <tr>
              <td>利息计算公式:</td>
            ...
            <tr>
              <td></td>
              <td>
                <button type="button" class="btn btn-default" onclick="addAsset();">提交</button>
...
<script language="JavaScript">
    ...
    function addAsset() {
        $.ajax({
            type : "POST",  //提交方式
            url : "<%=request.getContextPath()%>/asset/add/do",//路径
            async:false,
            data : {
